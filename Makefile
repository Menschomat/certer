...
build-darwin-arm64:
	...
	GOOS=darwin GOARCH=arm64 go build -o bin/keygen-darwin-arm64 cmd/keygen/main.go
...
build-linux-amd64:
	...
	GOOS=linux GOARCH=amd64 go build -o bin/keygen-linux-amd64 cmd/keygen/main.go
...
build-linux-arm64:
	...
	GOOS=linux GOARCH=arm64 go build -o bin/keygen-linux-arm64 cmd/keygen/main.go
