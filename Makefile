...
build-darwin-arm64:
	...
	GOOS=darwin GOARCH=arm64 go build -o bin/audit-darwin-arm64 ./cmd/audit
...
build-linux-amd64:
	...
	GOOS=linux GOARCH=amd64 go build -o bin/audit-linux-amd64 ./cmd/audit
...
build-linux-arm64:
	...
	GOOS=linux GOARCH=arm64 go build -o bin/audit-linux-arm64 ./cmd/audit
